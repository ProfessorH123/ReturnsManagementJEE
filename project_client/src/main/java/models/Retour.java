...
public class Retour implements Serializable {
    ...
    public Retour(int id, int idCommande, List<Article> articles, String raison, String status, String userMail,Date retourDate) {
        this.id = id;
    ...
    public String toString() {
        return "Retour{" + "id=" + id + ", idCommande=" + idCommande + ", articles=" + articles +
                ", raison='" + raison + '\'' + ", status='" + status + '\'' +  ", returned='" + returned + '\'' + ", userId=" + userMail + '}';
    }
